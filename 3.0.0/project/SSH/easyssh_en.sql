...
--
-- Host: localhost    Database: easyssh_en
-- ------------------------------------------------------
...
INSERT INTO `module_dept` VALUES (1,'Research','Beijing'),(2,'Sales','Shanghai'),(3,'Account','Guangzhou');
...
INSERT INTO `sys_menu_permission` VALUES (1,'EasyEE - SSH','',NULL,0,'icon-home2',''),(2,'System',NULL,1,0,'icon-application_view_tile','Management System，System manager'),(3,'User','toSysUser.action',2,0,'icon-user',NULL),(4,'Role','toSysRole.action',2,1,'icon-grade',NULL),(5,'Menu','toSysMenuPermission.action',2,2,'icon-menu',NULL),(6,'Operation','toSysOperationPermission.action',2,3,'icon-rights',NULL),(7,'Emp',NULL,1,1,'icon-report','HR'),(8,'Dept','Dept/page.action',7,1,'icon-group',''),(9,'Emp','Emp/page.action',7,2,'icon-id',''),(10,'Reports',NULL,1,3,'icon-chart_bar','Manager'),(11,'Chars','toReports.action',10,0,'icon-chart_curve',''),(13,'Logs','toSysLog.action',2,4,'icon-book','Logs detail');
...
INSERT INTO `sys_operation_permission` VALUES (37,5,'get menus','sysMenuPermission_list.action',''),(38,5,'edit menu','sysMenuPermission_update.action',''),(39,5,'delete menu','sysMenuPermission_delete.action',''),(40,5,'move menu order','sysMenuPermission_move.action',''),(41,5,'add menu','sysMenuPermission_save.action',''),(42,6,'menu list','sysMenuPermission_list.action',''),(43,6,'get operations by menu','sysOperationPermission_list.action',''),(44,6,'add operation permission','sysOperationPermission_save.action',''),(45,6,'edit operation permission','sysOperationPermission_update.action',''),(46,6,'delete operation permission','sysOperationPermission_delete.action',''),(47,4,' role list','sysRole_list.action',''),(48,4,'add role','sysRole_save.action,sysMenuPermission_listAll.action,sysMenuPermission_listAllForSysRole.action',''),(49,4,'edit role','sysRole_update.action#sysRole_getAllPermissionsId.action,sysMenuPermission_listAll.action,sysMenuPermission_listAllForSysRole.action','edit role need user roles'),(50,4,'delete role','sysRole_delete.action',''),(52,3,'user list','sysUser_list.action',''),(53,3,'add user','sysUser_save.action,sysRole_all.action',''),(54,3,'edit user','sysUser_update.action,sysRole_all.action',''),(55,3,'delete user','sysUser_delete.action',''),(56,3,'show add user button ','sysUserAddBtn','show permission'),(57,3,'show delete user button ','sysUserDelBtn','show permission'),(58,3,'show edit user button ','sysUserUpdateBtn','show permission'),(59,3,'show real name column info','showRealNameColumn','show permission'),(60,8,'add dept','Dept/save.action',''),(61,8,'edit dept','Dept/update.action',''),(62,8,'delete dept','Dept/delete.action',''),(63,8,'get depts','Dept/list.action',''),(64,8,'show permission -delete dept','deptDeleteShow',''),(65,9,'add emp','Emp/save.acton',''),(66,9,'edit emp','Emp/update.action,Emp/allDept.action',''),(67,9,'delete emp','Emp/delete.action',''),(68,9,'get emp list','Emp/list.action,Emp/allDept.action',''),(69,13,'log list','sysLog_list.action',''),(70,1,'Main page permission','toMain.action',' must grant to login user'),(71,3,'role list','sysRole_all.action',''),(72,4,'get menu and operation permissions','sysRole_getAllPermissionsId.action,sysMenuPermission_listAll.action,sysMenuPermission_listAllForSysRole.action',''),(73,1,'edit password','sysUser_changePwd.action','Change Password');
...
-- Dump completed on 2016-12-07 18:05:31
