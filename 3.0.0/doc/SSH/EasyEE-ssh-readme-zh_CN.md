...
EasyEE 是一个 JaveEE 后台开发基础框架。

基于广泛使用的 JaveEE 框架及 EasyUI 前端框架，提供了基于用户、角色、权限方案的权限管理系统，安全管理框架及常用开发组件。为企业后台项目开发提供了基础架构和规范。
...
6. **访问和权限配置**
   ...
   1. 通过系统管理员, 添加新模块`菜单权限`(`/Dept/page.action`, 点击菜单访问 JSP 视图的 action 请求)
