...
<body>
	<div
		...
		<h1><span style="color:#8FC31F">Easy</span><span style="color:#376E91">E</span><span style="color:#376E91">E</span>-<span style="">SSH(JPA)</span></h1>
	<div class="title">
	( <span class="fname">SSH(JPA)</span>
