...
<div id="sysMenuPermissionEditDialog" class="easyui-dialog"
	...
	<input type="hidden" name="sysMenuPermission.menuPermissionId"/>
			 <table cellpadding="5">
	    		<tr>
	    			<td>菜单名称:</td>
	    			<td><input class="easyui-textbox easyui-validatebox" name="sysMenuPermission.name"
				 required="true" style="width: 200px" 
				data-options="prompt:'input menu name...'"> <span class="required">*</span></td>
	    		</tr>
	    		<tr>
	    			<td>菜单动作:</td>
	    			<td><input  style="width: 200px"  class="easyui-textbox" name="sysMenuPermission.action"></td>
	    		</tr>
	    		<tr>
	    			<td>菜单图标类样式:</td>
	    			<td>
	    		...
	    		<tr>
	    			<td>父菜单:</td>
	    			<td>
	    				    <input id="sysMenuPermissionEditParent" name="sysMenuPermission.sysMenuPermission.menuPermissionId" class="easyui-combotree" style="width:200px;"/>
