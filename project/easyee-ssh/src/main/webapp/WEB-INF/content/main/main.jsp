...
<html>
  <head>
    ...
    <title>EasyEE-SSH Management</title>
    
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">    
	<meta http-equiv="keywords" content="ssh,easyee,javaee,framework,java">
	<meta http-equiv="description" content="EasyEE-SSH basic framework by EasyProject">
...
<script type="text/javascript" src="staticresources/easyuiex/easy.easyuiex.min-2.2.3.js"></script>
...
<body class="easyui-layout" >
 ...
 --%>
		...
		<div id="easysshtop" data-options="region:'north',split:true"
			style="height:120px;padding: 0 20px;" title="EasyEE-SSH(JPA) Demo (Struts 2.5.X + Hibernate 5.X + Spring 4.X + EasyShiro 2.X + EasyCommonDAO + EasyFilter 2.X + EasyUI + EasyUIEX )">
			<h1 style="display: inline;line-height: 80px;font-size: 38px;font-family: 'Roboto Condensed', 微软雅黑; font-weight: 700; ">
			
		<%-- 	<img alt="" src="images/logo.png"/> --%>  
		<span style="color:#8FC31F">Easy</span><span style="color:#376E91">E</span><span style="color:#376E91">E</span>-<span style="color:#000000">SSH</span> Basic Development Platform
			</h1>
			...
			${USER.realName }</span> 
			<span id="showtime"><s:date name="#request.now" format="yyyy年MM月dd日 HH:mm:ss"/> </span>
 ...
 --%>
		...
		<div data-options="region:'center',split:true"  >
			<div class="easyui-tabs" id="tabs" data-options="fit:true">
				...
				<div title="框架手册"  iconCls="icon-book"  data-options="fit:true, content:'<iframe src=\'doc/easyee-ssh-readme-single_zh_CN.html?v=1\' frameborder=\'0\' style=\'height:500px;width:100%;\'  ></iframe>'"></div> 
