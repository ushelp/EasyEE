...
<script type="text/javascript">
	...
	$(function() {
		...
		sysLog.doSearch = function() {
			dg.datagrid("load", {
				'sysLogCriteria.account' : $("#sysLogAccount").val(),
				'sysLogCriteria.ip' : $("#sysLogIp").val(),
				'sysLogCriteria.startTime' : $("#sysLogStartTime").datetimebox("getValue"),
				'sysLogCriteria.endTime' : $("#sysLogEndTime").datetimebox("getValue")
			});
		}
...
<div id="sysLogToolbar">
	<div>
		<span>账户:</span> <input name="sysLogCriteria.account" id="sysLogAccount" class="easyui-textbox" />
		<span>IP:</span> <input name="sysLogCriteria.ip" id="sysLogIp" class="easyui-textbox" />
		<span>操作日期:</span>
		 <input name="sysLogCriteria.startTime" id="sysLogStartTime" class="easyui-datetimebox" style="width:200px" data-options="
            prompt: '开始时间',
            icons:[{
                iconCls:'icon-clear',
                handler: function(e){
            ...
            "> - 
		 <input name="sysLogCriteria.endTime" id="sysLogEndTime" class="easyui-datetimebox" style="width:200px" data-options="
            prompt: '结束时间',
            icons:[{
                iconCls:'icon-clear',
                handler: function(e){
		...
		<a class="easyui-linkbutton" iconCls="icon-search" plain="true"
			onclick="sysLog.doSearch()"><s:text name="label.search"></s:text></a>
	</div>
