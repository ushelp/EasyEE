	...
	<form id="sysUserEditForm" method="post">
			<input name="sysUser.userId" type="hidden">
			 <table cellpadding="5">
				...
				class="easyui-validatebox" id="editPwd" validType="minLength['6']"  style="width: 200px">（不填写则不修改）</td>
	    		</tr>
	    		<tr>
	    			<td>确认密码:</td>
	    			<td><input type="password" class="easyui-textbox" name="confirmPwd"
						class="easyui-validatebox" validType="equals['#editPwd','与两次密码不一致.']"  style="width: 200px"></td>
	    		</tr>
	    		<tr>
	    			<td>状态:</td>
	    			<td>
