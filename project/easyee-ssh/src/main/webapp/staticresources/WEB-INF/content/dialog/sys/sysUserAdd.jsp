	...
	<form id="sysUserAddForm" method="post">
			<input name="userId" type="hidden">
			 <table cellpadding="5">
	    		<tr>
	    			<td>用户名:</td>
	    			<td><input class="easyui-textbox" name="sysUser.name"
				class="easyui-validatebox" required="true"
				data-options="prompt:'input username...'" style="width: 200px"><span class="required">*</span></td>
	    		</tr>
	    		<tr>
	    			<td>真实姓名:</td>
	    			<td><input class="easyui-textbox" name="sysUser.realName"
				class="easyui-validatebox" style="width: 200px"></td>
	    		</tr>
	    		<tr>
	    			<td>密码:</td>
	    			<td><input type="password" class="easyui-textbox" name="sysUser.password"
				class="easyui-validatebox" id="password" required="true" validType="minLength['6']" style="width: 200px"><span class="required">*</span></td>
	    		</tr>
	    		<tr>
	    			<td>确认密码:</td>
	    			<td><input type="password" class="easyui-textbox" name="confirmPwd"
						class="easyui-validatebox" required="true" validType="equals['#password','与两次密码不一致.']" style="width: 200px"><span class="required">*</span></td>
	    		</tr>
	    		<tr>
	    			<td>状态:</td>
	    			<td>
						<input type="radio" name="sysUser.status" value="0" id="on" checked="checked"  />
						<label for="on">启用</label> 
						<input type="radio" name="sysUser.status" value="1" id="off" />
