...
import cn.easyproject.easyee.sh.base.util.SpringUtil;
...
//				System.out.println(menus.get(0).getSysMenuPermissions());
		...
		System.out.println(EasyObjectExtract.extract(menus, "menuPermissionId","action","icon","name","remark","sortOrder","sysMenuPermission","sysMenuPermissions"));
	}
