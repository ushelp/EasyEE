...
<html>
  <head>
    ...
    <title>EasyEE-SH Spring Boot Management</title>
...
<script type="text/javascript" src="staticresources/easyee/easyee-sh.main.js"></script>
...
<body class="easyui-layout" >
 ...
 --%>
		...
		<div id="easysshtop" data-options="region:'north',split:true"
			style="height:120px;padding: 0 20px;" title="EasyEE-SH(JPA) Demo (Spring Boot 1.4.2 + Hibernate 5.X + EasyShiro 2.X + EasyCommonDAO + EasyFilter 2.X + EasyUI + EasyUIEX )">
			<h1 style="display: inline;line-height: 80px;font-size: 38px;font-family: 'Roboto Condensed', 微软雅黑; font-weight: 700; ">
			
		<%-- 	<img alt="" src="images/logo.png"/> --%>  
		<span style="color:#8FC31F">Easy</span><span style="color:#376E91">E</span><span style="color:#376E91">E</span>-<span style="color:#000000">SH Spring Boot</span> Basic Development Platform
			</h1>
 ...
 --%>
		...
		<div data-options="region:'center',split:true"  >
			<div class="easyui-tabs" id="tabs" data-options="fit:true">
				<%-- <div title="最近报表"  iconCls="icon-chart_bar" data-options="href:'jsp/echarts/echartsDemo'"></div> --%>
				<div title="框架手册"  iconCls="icon-book"  data-options="fit:true, content:'<iframe src=\'doc/easyee-sh-readme-single_zh_CN.html?v=1\' frameborder=\'0\' style=\'height:500px;width:100%;\'  ></iframe>'"></div> 
