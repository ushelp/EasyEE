...
public class SysOperationPermission implements java.io.Serializable {
	...
	@JoinTable(name = "sys_role_operation", joinColumns = {
			@JoinColumn(name = "OPERATION_PERMISSION_ID") }, inverseJoinColumns = { @JoinColumn(name = "ROLE_ID") })
	...
	/** full constructor */
	public SysOperationPermission(SysMenuPermission sysMenuPermission, String name, String action, String remark) {
	...
	public String toString() {
		return "SysOperationPermission [operationPermissionId=" + operationPermissionId + ", name=" + name + ", action="
